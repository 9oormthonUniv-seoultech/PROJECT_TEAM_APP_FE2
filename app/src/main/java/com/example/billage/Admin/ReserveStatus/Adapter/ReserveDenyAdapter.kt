...
class ReserveDenyAdapter(private val reserves: List<ReserveItem>) : RecyclerView.Adapter<ReserveDenyAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemReserveManagementBinding) :
        ...
        val button = binding.buttonManageReserve
    }
}