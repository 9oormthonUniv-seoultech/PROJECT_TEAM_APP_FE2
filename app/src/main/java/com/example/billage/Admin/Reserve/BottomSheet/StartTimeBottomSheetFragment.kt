...
class StartTimeBottomSheetFragment : BottomSheetDialogFragment() {

    lateinit var binding: BottomsheetTimeBinding

    interface OnTimeSelectedListener {
        fun onTimeStartSelected(ampm: String, hour: Int, minute: Int)
    }
    ...
    override fun onDismiss(dialog: DialogInterface) {
        ...
        binding.run {
            ...
            onTimeSelectedListener?.onTimeStartSelected(ampm, hour, minute)
        }
    }
}
