...
class ReserveAcceptAdapter(private val reserves: List<ReserveItem>) : RecyclerView.Adapter<ReserveAcceptAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.buttonCancel.text = "예약 취소하기"
    }
    ...
    inner class ViewHolder(val binding: ItemReserveManagementBinding) :
        ...
        val buttonCancel = binding.buttonManageReserve
